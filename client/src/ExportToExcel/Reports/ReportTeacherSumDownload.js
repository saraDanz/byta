...
// export default function ReportTeacherSumDownlaod({ props }) {//
...
//             <View fixed>
//                 <Text style={{  marginTop:3,fontSize:15,display: "block", textAlign: "center", width: "100%", minHeight: "20","marginBottom":"2" }}> דוח סיכום שעות לפי מורה </Text>
//                 <Text style={{  marginTop:3,fontSize:15,display: "block", textAlign: "center", width: "100%", minHeight: "20","marginBottom":"2" }}>
//                 {fromDate && toDate ? "לתאריכים"+fromDate.$d.toLocaleDateString()+"-"+toDate.$d.toLocaleDateString():
