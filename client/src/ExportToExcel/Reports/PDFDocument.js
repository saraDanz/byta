...
// const Table = ({ children,  th, columns }) => (
...
//     </View>
// )
// const PDFDocument = ({ columns, data ,header}) => (
//     <Document>
//         <Page size="A4" style={styles1.page}>

//             <View fixed>
//                 <Text style={{  marginTop:3,fontSize:15,display: "block", textAlign: "center", width: "100%", minHeight: "20","marginBottom":"2" }}>{header}דוח לחודש</Text>
//             </View>
//             <Table
//                 th
//                 columns={columns}
